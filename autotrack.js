(function() {
	...
	g.observeElements = function(a) {
		...
		this.b ||
			((this.b = new MutationObserver(this.M)), this.b.observe(document.body, { childList: !0, subtree: !0 }));
			...
			for (var e = 0, h; (h = this.items[e]); e++) {
				...
				if ((f = d.target.id === h.id))
					(f = h.threshold)
						...
						: ((f = d.intersectionRect), (f = 0 < f.top || 0 < f.bottom || 0 < f.left || 0 < f.right));
				if (f) {
					var v = h.id;
	...
	function Sa(a, b) {
		...
		document.visibilityState &&
			((this.a = A({ sessionTimeout: Ha, visibleThreshold: 5e3, sendInitialPageview: !1, fieldsObj: {} }, b)),
			(this.b = a),
