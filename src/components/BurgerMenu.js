    ...
    return (
      <Menu>
        <div className="burger-menu__text-container">
          <p>
            This site was created to present price fluctuations of crypto assets
            and the news/gossip that may have caused them. Crypto Hitters could
            not have been made without resources provided by{" "}
            <a
            ...
            {""} If you wish to contact me directly, please do so via contact
            options below.
            <br />
            <br />
            Cheers,
        ...
        <div className="burger-menu__contact-container">
          ...
          <p className="burger-menu__link">johnggribbin @ gmail.com</p>
        </div>
      </Menu>
    );
  }
