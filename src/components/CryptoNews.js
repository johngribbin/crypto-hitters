...
class CryptoNews extends Component {
  ...
  componentDidMount() {
    ...
    getRedditResults(chosenCryptoName).then((response) => {
      let sortedRedditResults = sortBySubreddit(
      ...
      <div>
        ...
        <section className="news__header-section">
          <div className="news__icon-container--left">
            <Link to="/">
              <i className="material-icons md-48 float-left">
                keyboard_arrow_left
              </i>
            </Link>
          </div>
        ...
        <ReactModal isOpen={showModal} contentLabel="Minimal Modal Example">
          <i
            className="material-icons md-36 float-right"
          ...
          <div className="modal__container">
            <div className="modal__content-container">
              ...
              <p className="modal__paragraph">
                This page aims to bring you the most relevant Reddit posts for
                the crypto asset chosen.
              </p>
              <ul className="modal__list">
                <li className="modal__list-item">
                  Posts with more comments are given priority.
                </li>
                <li className="modal__list-item">
                  Green colored SubReddit links signify a greater chance of a
                  relevant post and will always appear first.
                </li>
                <li className="modal__list-item">
                  Click the chart icon to view the previous 60 days price
                  action.
                </li>
                <li className="modal__list-item">
                  If reddit posts are not satisfactory, click the globe icon to
                  launch a web search by DuckDuckGo.
                </li>
        ...
        <ul className="news__reddit-list">
          <RedditResults
            ...
            chosenCryptoName={chosenCryptoName}
          />
        </ul>
      </div>
    );
