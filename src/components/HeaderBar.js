          ...
          <div className="modal__container">
            <div className="modal__content-container">
              <p className="modal__paragraph">
                This site was created to present price fluctuations of crypto
                assets and the news/gossip that may have caused them. Crypto
                Hitters could not have been made without resources provided by{" "}
                <a
                ...
                {""} If you wish to contact me directly, please do so via the
                contact options.
                <br />
                <br />
                Cheers,
        ...
        >
          ...
          <div className="modal__container">
            <div className="modal__content-container">
              ...
              <p className="contact-modal__email-link">
